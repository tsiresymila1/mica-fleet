...
const kRayonTransbordementMetres =
    20.0; // ponytail: paramétrable Odoo plus tard

final transportRepoProvider = Provider<TransportRepository>(
  (ref) => TransportRepositoryImpl(
...
final validateTransbordementProvider = Provider(
  (ref) => ValidateTransbordement(),
);

final removeTransbordementProvider = Provider((ref) => RemoveTransbordement());
