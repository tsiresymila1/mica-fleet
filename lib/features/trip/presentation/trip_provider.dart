...
final tripTrackerProvider = Provider<TripTracker>(
  (ref) => TripTracker(ref.watch(dbProvider)),
);

/// Points du trajet d'un chargement (pour la carte).
final trajetPointsProvider = FutureProvider.autoDispose
    .family<List<LatLng>, String>((ref, id) async {
