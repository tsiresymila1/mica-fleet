      ...
      Expanded(
        child: Column(
          ...
          children: [
            ...
            if (sousTitre != null)
              Text(sousTitre!, style: Theme.of(context).textTheme.bodyMedium),
          ],
        ),
      ),
    ],
      ...
      child: Row(
        ...
        children: [
          ...
          Text(
            ...
            style: Theme.of(
              context,
            ).textTheme.labelLarge!.copyWith(color: fg, fontSize: 12.5),
          ),
        ],
      ),
    );
...
/// Notification brève non bloquante pour confirmer le lancement d'une action.
void showAppToast(
  BuildContext context,
  String message, {
  AppMsgKind kind = AppMsgKind.info,
}) {
  final (color, icon) = switch (kind) {
    AppMsgKind.success => (AppColors.ok, Icons.check_circle),
    AppMsgKind.warning => (AppColors.warn, Icons.error),
    AppMsgKind.error => (AppColors.danger, Icons.cancel),
    AppMsgKind.info => (AppColors.primary, Icons.info),
  };
